...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2019 at 05:26 PM
...
(11, 'Intro to ComSci: C language', 'Learn how to code in C language!!', 1, 3),
(21, 'C++ Course', 'After C, improve with C++', 1, 1),
(23, 'Java: The Programming Language', 'Learn how to take over the world with Java', 1, 3),
(123, 'Data Structures', 'Use any language you want to implement several data structures', 0, 4);
...
INSERT INTO `quiz` (`Quiz_ID`, `Quiz_Name`, `Quiz_Difficulty`, `Quiz_Description`, `Course_ID`, `Quiz_PassingScore`, `User_ID`) VALUES
(1, 'C Test no. 1', 'EASY', 'Test to see basic C syntax', 11, 60, 3),
(2, 'C Test no. 2', 'EASY', NULL, 11, 60, 3),
(4, 'Can you Java 1', 'EASY', NULL, 23, 60, 3),
(5, 'Can you Java 2', 'MEDIUM', NULL, 23, 60, 3),
(6, 'Data Structures Exam 1', 'MEDIUM', NULL, 123, 50, 4),
(7, 'Data Structures Exam 2', 'HARD', NULL, 123, 45, 4);
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `course_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `registered_user` (`User_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `quiz`
  ADD CONSTRAINT `quiz_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `registered_user` (`User_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
