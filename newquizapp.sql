...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2019 at 12:10 PM
...
INSERT INTO `multiplechoice` (`Question_ID`, `Choice1`, `Choice2`, `Choice3`, `Choice4`, `Answer`) VALUES
(1, 'printf', 'echo', 'System.out.println', 'cout', 'printf');
...
INSERT INTO `question` (`Quiz_ID`, `Question_ID`, `Question_Description`, `Quiz_Type`) VALUES
(1, 1, 'How to print text?', 'MC'),
(1, 2, 'The way to import the header file for standard input and output', 'I'),
(1, 3, 'To access the values that the user enters, the syntax to use is scanf.', 'ToF');
