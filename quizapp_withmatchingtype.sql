...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2019 at 05:11 AM
...
(15, 12, '', 'ToF', 'Rodrigo'),
(16, 14, 'Bell Curve', 'ToF', 'Normal Distribution'),
(14, 15, 'Who is the president?', 'ToF', 'Leni'),
(17, 16, 'heqwu', 'ToF', 'ewqeweq'),
(18, 17, 'Hhoho', 'MT', 'gege'),
(19, 18, 'Who are you', 'MT', 'I am me');
...
(11, 'hhelo', 'EASY', 'eee', NULL, 100, '', 8, 1, 'hey'),
(14, 'ee', 'MEDIUM', 'eee', NULL, 100, '', 8, 1, 'Hey'),
(15, 'ee', 'EASY', 'eee', NULL, 13, '', 8, 1, 'Hello'),
(16, 'eqw', 'MEDIUM', 'World', NULL, 13, '', 8, 1, 'Hardest Quiz'),
(17, 'ee', 'MEDIUM', 'eee', NULL, 13, '', 8, 1, 'hey'),
(18, 'ee', 'EASY', 'll', NULL, 13, '', 8, 1, 'Hardest Quiz'),
(19, 'ee', 'EASY', 'll', NULL, 40, '', 8, 1, 'Hardest Quiz');
...
(8, 'pio', 'pio@yhoo.com', 'laguna', '202cb962ac59075b964b07152d234b70');
...
--
ALTER TABLE `quiz`
  ADD CONSTRAINT `quiz_course_id` FOREIGN KEY (`Course_ID`) REFERENCES `course` (`Course_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
